...
inline size_t const_bit_set_operation::scan_lead(size_t offset, size_t max_len)
{
...
inline size_t const_bit_set_operation::scan_zero(size_t offset, size_t max_len)
{
