...
template <typename R, bool IsNoexcept, typename... Args> class delegate_impl
{
  private:
    ...
    static R invoke_function(const void *, Args... args) noexcept(IsNoexcept)
    {
    ...
    static R invoke_member(const void *object, Args... args) noexcept(IsNoexcept)
    {
  ...
  public:
    ...
    template <auto Function>
    static constexpr delegate_impl bind() noexcept
    {
    ...
    template <auto Method, typename T>
    static constexpr delegate_impl bind(T &object) noexcept
    {
    ...
    template <typename F>
    static constexpr delegate_impl borrow(F &callable) noexcept
    {
