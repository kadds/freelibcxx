...
{
trunk_buffer::trunk_buffer(size_t trunk_size, size_t max_trunk_count, strategy full_strategy,
...
size_t trunk_buffer::write(const std::byte *buffer, size_t size)
{
    size_t cur_write = 0;
...
std::byte *trunk_buffer::read_buffer(size_t *size)
{
...
trunk_buffer::trunk *trunk_buffer::new_trunk()
{
...
void trunk_buffer::delete_trunk(trunk_buffer::trunk *t)
{
    count_--;
